...
def home():
    ...
    # Initialize levels
    level_descriptions = {
        '1': 'In this level, you must bypass the login system using SQL injection techniques.',
        '2': 'Solve the Caesar cipher to reveal the plaintext.',
        '3': 'Crack the next puzzle to proceed.',
        '4': 'Decode the hidden message to proceed to the next level.',
